...
\item[]{Experienced in Python, MATLAB,  Wolfram Mathematica}
...
\begin{benumerate}{5}
\item Wang, H., B\^{o}as, A.B.V., Young, W.R. and Vanneste J. \textit{Scattering of swell by currents.} Submitted to Journal of Fluid Mechanics. \href{https://arxiv.org/abs/2305.12163}{[arXiv]}
...
\item[--]{Graduate students: Jeff Uncu, University of Toronto, 2022/10-2023/10(expected)}
\end{itemize}
